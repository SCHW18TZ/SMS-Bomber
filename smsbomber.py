...
while True:
    ...
    driver.find_element(
        'xpath', "/html/body/app-root/jds-theme/jds-container/app-layout-ds/div/main/div/app-login/jds-grid/div/jds-container[2]/section/div/form/div[1]/jds-phone/div/input").send_keys(username)

    driver.find_element(
        'xpath', "/html/body/app-root/jds-theme/jds-container/app-layout-ds/div/main/div/app-login/jds-grid/div/jds-container[2]/section/div/form/div[2]/jds-button/button").click()
    ...
    try:
        ...
        driver.find_element(
            "xpath", "/html/body/div/div/main/div[1]/div/div/div[3]/form/div[1]/div/div[2]/div/input").send_keys(username)
